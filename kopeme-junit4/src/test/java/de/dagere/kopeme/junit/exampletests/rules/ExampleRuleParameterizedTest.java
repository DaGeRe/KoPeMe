...
public class ExampleRuleParameterizedTest {
   @Rule
   ...
   public ExampleRuleParameterizedTest(final int value) {
      this.value = value;
   }

   @Test
   @PerformanceTest(iterations = 5, warmup = 5, timeout = 50000, useKieker = false)
