package de.dagere.kopeme.collections;
...
public class SynchronizedCircularFifoQueue<E> extends AbstractCollection<E>
    ...
    public SynchronizedCircularFifoQueue(final int size) {
        if (size <= 0) {
     ...
     */
    public SynchronizedCircularFifoQueue(final Collection<? extends E> coll) {
        this(coll.size());
        addAll(coll);
    }
...
//        Omit null check - eventually save some nanoseconds
//        if (null == element) {
        ...
        return new Iterator<E>() {
            ...
            public void remove() {
                ...
                if (lastReturnedIndex == start) {
                    SynchronizedCircularFifoQueue.this.remove();
                    lastReturnedIndex = -1;
                    return;
                }
