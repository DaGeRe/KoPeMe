...
/**
 * This annotation of a <code>public class</code> tells that this class contains performance test. It mainly enables to set the overall timeout for all tests of a class. With this
